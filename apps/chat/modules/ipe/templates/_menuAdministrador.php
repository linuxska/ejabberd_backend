...
?>
   ...
   <li class="menu_role">
            <ul class="menu_sub">
                <li class ="menu_sub_header"><a class="alternate" href="<?php echo url_for('@homepage') ?>"></a>Historial de Chat</a></li>
                <li class="app <?php echo in_array('mensajes', explode('/', $sf_request->getUri())) ? "selected" : "" ?>"><a href="<?php echo url_for('@archive_messages') ?>" class="alternate">Mensajes</a></li>
            </ul>
    </li>
    </li>